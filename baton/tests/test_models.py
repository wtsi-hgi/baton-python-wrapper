...
class TestIrodsFile(unittest.TestCase):
    ...
    def setUp(self):
        self.irods_file = IrodsFile(
            TestIrodsFile._DIRECTORY, TestIrodsFile._FILENAME, TestIrodsFile._CHECKSUMS[0], [], [])

    def test_get_invalid_replicas_with_no_replicas(self):
        self.assertCountEqual(self.irods_file.get_invalid_replicas(), [])
    ...
    def test_get_invalid_replicas_with_no_valid_replicas(self):
        ...
        self.irods_file.replicas = replicas

        self.assertCountEqual(self.irods_file.get_invalid_replicas(), replicas)
    ...
    def test_get_invalid_replicas_with_mixed_valid_replicas(self):
        ...
        self.assertCountEqual(self.irods_file.get_invalid_replicas(), replicas[1:])
